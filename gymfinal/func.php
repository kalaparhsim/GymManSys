    ...
    if(isset($_POST['pay_submit']))
        {
            ...
            if($result)
            {
              echo "<script>alert('Payment sucessfull.')</script>";
                ...
                echo "<script>alert('Error! payment Not added.')</script>";
                echo "<script>window.open('payment.php','_self')</script>";
            }
            } 
